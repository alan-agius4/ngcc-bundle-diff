...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Location, [{
    ...
    }]; }, { constructor: [], _subject: [], _platformStrategy: [], _baseHref: [], path: [], isCurrentPathEqualTo: [], normalize: [], prepareExternalUrl: [], go: [], replaceState: [], forward: [], back: [], subscribe: [] });
Location.ngInjectableDef = ɵngcc0.defineInjectable({ token: Location, factory: function Location_Factory(t) { return new (t || Location)(ɵngcc0.inject(LocationStrategy)); }, providedIn: null });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgClass, [{
        ...
        type: Renderer2
    }]; }, { constructor: [], _iterableDiffers: [], _keyValueDiffers: [], _ngEl: [], _renderer: [], _initialClasses: [], klass: [{
            type: Input,
            args: ['class']
        }], ngClass: [{
            type: Input
        }], _iterableDiffer: [], _keyValueDiffer: [], _rawClass: [], ngDoCheck: [], _applyKeyValueChanges: [], _applyIterableChanges: [], _applyClasses: [], _removeClasses: [], _toggleClass: [] });
NgClass.ngDirectiveDef = ɵngcc0.ɵdefineDirective({ type: NgClass, selectors: [["", "ngClass", ""]], factory: function NgClass_Factory(t) { return new (t || NgClass)(ɵngcc0.ɵdirectiveInject(IterableDiffers), ɵngcc0.ɵdirectiveInject(KeyValueDiffers), ɵngcc0.ɵdirectiveInject(ElementRef), ɵngcc0.ɵdirectiveInject(Renderer2)); }, inputs: { klass: ["class", "klass"], ngClass: "ngClass" } });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgComponentOutlet, [{
    ...
    }]; }, { constructor: [], _viewContainerRef: [], _componentRef: [], _moduleRef: [], ngOnChanges: [], ngOnDestroy: [], ngComponentOutlet: [{
            type: Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgForOf, [{
        ...
        type: IterableDiffers
    }]; }, { constructor: [], _viewContainer: [], _template: [], _differs: [], _ngForOfDirty: [], _differ: [], ngForOf: [{
            type: Input
        }], _ngForOf: [], ngForTrackBy: [{
            type: Input
        }], _trackByFn: [], ngForTemplate: [{
            type: Input
        }], ngDoCheck: [], _applyChanges: [], _perViewChange: [] });
NgForOf.ngDirectiveDef = ɵngcc0.ɵdefineDirective({ type: NgForOf, selectors: [["", "ngFor", "", "ngForOf", ""]], factory: function NgForOf_Factory(t) { return new (t || NgForOf)(ɵngcc0.ɵdirectiveInject(ViewContainerRef), ɵngcc0.ɵdirectiveInject(TemplateRef), ɵngcc0.ɵdirectiveInject(IterableDiffers)); }, inputs: { ngForOf: "ngForOf", ngForTrackBy: "ngForTrackBy", ngForTemplate: "ngForTemplate" } });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgIf, [{
        ...
        type: TemplateRef
    }]; }, { constructor: [], _viewContainer: [], _context: [], _thenTemplateRef: [], _elseTemplateRef: [], _thenViewRef: [], _elseViewRef: [], ngIf: [{
            type: Input
        }], ngIfThen: [{
            type: Input
        }], ngIfElse: [{
...
NgSwitch.ngDirectiveDef = ɵngcc0.ɵdefineDirective({ type: NgSwitch, selectors: [["", "ngSwitch", ""]], factory: function NgSwitch_Factory(t) { return new (t || NgSwitch)(); }, inputs: { ngSwitch: "ngSwitch" } });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgPlural, [{
        ...
        type: NgLocalization
    }]; }, { constructor: [], _localization: [], _caseViews: [], ngPlural: [{
            type: Input
        }], _switchValue: [], addCase: [], _updateView: [], _clearViews: [], _activateView: [], _activeView: [] });
NgPlural.ngDirectiveDef = ɵngcc0.ɵdefineDirective({ type: NgPlural, selectors: [["", "ngPlural", ""]], factory: function NgPlural_Factory(t) { return new (t || NgPlural)(ɵngcc0.ɵdirectiveInject(NgLocalization)); }, inputs: { ngPlural: "ngPlural" } });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgStyle, [{
        ...
        type: Renderer2
    }]; }, { constructor: [], _differs: [], _ngEl: [], _renderer: [], ngStyle: [{
            type: Input
        }], _ngStyle: [], _differ: [], ngDoCheck: [], _applyChanges: [], _setStyle: [] });
NgStyle.ngDirectiveDef = ɵngcc0.ɵdefineDirective({ type: NgStyle, selectors: [["", "ngStyle", ""]], factory: function NgStyle_Factory(t) { return new (t || NgStyle)(ɵngcc0.ɵdirectiveInject(KeyValueDiffers), ɵngcc0.ɵdirectiveInject(ElementRef), ɵngcc0.ɵdirectiveInject(Renderer2)); }, inputs: { ngStyle: "ngStyle" } });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgTemplateOutlet, [{
        ...
        type: ViewContainerRef
    }]; }, { constructor: [], _viewContainerRef: [], ngOnChanges: [], _viewRef: [], _shouldRecreateView: [], _hasContextShapeChanged: [], _updateExistingContext: [], ngTemplateOutletContext: [{
            type: Input
        }], ngTemplateOutlet: [{
            type: Input
        }] });
...
DeprecatedDatePipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "date", type: DeprecatedDatePipe, factory: function DeprecatedDatePipe_Factory(t) { return new (t || DeprecatedDatePipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/**
 * \@internal
 */
...
DeprecatedDecimalPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "number", type: DeprecatedDecimalPipe, factory: function DeprecatedDecimalPipe_Factory(t) { return new (t || DeprecatedDecimalPipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
DeprecatedPercentPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "percent", type: DeprecatedPercentPipe, factory: function DeprecatedPercentPipe_Factory(t) { return new (t || DeprecatedPercentPipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
DeprecatedCurrencyPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "currency", type: DeprecatedCurrencyPipe, factory: function DeprecatedCurrencyPipe_Factory(t) { return new (t || DeprecatedCurrencyPipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AsyncPipe, [{
    ...
    }]; }, { constructor: [], _ref: [], _latestValue: [], _latestReturnedValue: [], _subscription: [], _obj: [], _strategy: [], ngOnDestroy: [], transform: [], _subscribe: [], _selectStrategy: [], _dispose: [], _updateLatestValue: [] });
AsyncPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "async", type: AsyncPipe, factory: function AsyncPipe_Factory(t) { return new (t || AsyncPipe)(ɵngcc0.ɵdirectiveInject(ChangeDetectorRef)); }, pure: false });
/** @nocollapse */
...
LowerCasePipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "lowercase", type: LowerCasePipe, factory: function LowerCasePipe_Factory(t) { return new (t || LowerCasePipe)(); }, pure: true });
//
...
TitleCasePipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "titlecase", type: TitleCasePipe, factory: function TitleCasePipe_Factory(t) { return new (t || TitleCasePipe)(); }, pure: true });
/**
...
UpperCasePipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "uppercase", type: UpperCasePipe, factory: function UpperCasePipe_Factory(t) { return new (t || UpperCasePipe)(); }, pure: true });
...
DatePipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "date", type: DatePipe, factory: function DatePipe_Factory(t) { return new (t || DatePipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(I18nPluralPipe, [{
        ...
        type: NgLocalization
    }]; }, { constructor: [], _localization: [], transform: [] });
I18nPluralPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "i18nPlural", type: I18nPluralPipe, factory: function I18nPluralPipe_Factory(t) { return new (t || I18nPluralPipe)(ɵngcc0.ɵdirectiveInject(NgLocalization)); }, pure: true });
/** @nocollapse */
...
I18nSelectPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "i18nSelect", type: I18nSelectPipe, factory: function I18nSelectPipe_Factory(t) { return new (t || I18nSelectPipe)(); }, pure: true });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(KeyValuePipe, [{
        ...
        type: KeyValueDiffers
    }]; }, { constructor: [], differs: [], keyValues: [], transform: [], differ: [] });
...
DecimalPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "number", type: DecimalPipe, factory: function DecimalPipe_Factory(t) { return new (t || DecimalPipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
PercentPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "percent", type: PercentPipe, factory: function PercentPipe_Factory(t) { return new (t || PercentPipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
CurrencyPipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "currency", type: CurrencyPipe, factory: function CurrencyPipe_Factory(t) { return new (t || CurrencyPipe)(ɵngcc0.ɵdirectiveInject(LOCALE_ID)); }, pure: true });
/** @nocollapse */
...
SlicePipe.ngPipeDef = ɵngcc0.ɵdefinePipe({ name: "slice", type: SlicePipe, factory: function SlicePipe_Factory(t) { return new (t || SlicePipe)(); }, pure: false });
...
//# sourceMappingURL=D:/sandbox/ngcc-bundle-diff/node_modules/@angular/common/fesm2015/common.js.map