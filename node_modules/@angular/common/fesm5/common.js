...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(Location, [{
    ...
    }]; }, { _subject: [], _platformStrategy: [], _baseHref: [], path: [], isCurrentPathEqualTo: [], normalize: [], prepareExternalUrl: [], go: [], replaceState: [], forward: [], back: [], subscribe: [] });
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(NgTemplateOutlet, [{
        ...
        type: ViewContainerRef
    }]; }, { _viewContainerRef: [], _viewRef: [], ngTemplateOutletContext: [{
            type: Input
        }], ngTemplateOutlet: [{
            type: Input
...
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(AsyncPipe, [{
    ...
    }]; }, { _ref: [], _latestValue: [], _latestReturnedValue: [], _subscription: [], _obj: [], _strategy: [], ngOnDestroy: [], transform: [], _subscribe: [], _selectStrategy: [], _dispose: [], _updateLatestValue: [] });
...
//# sourceMappingURL=c:/git/ngcc-bundle-diff/node_modules/@angular/common/fesm5/common.js.map